        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 pb-12 border-b border-slate-800/60">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-lg font-bold text-white tracking-tight">
                Vigilant Agent Compliance
              </span>
            </div>
            <p className="text-xs leading-relaxed text-slate-400 max-w-sm">
              Empowering enterprise cloud architecture with autonomous Agentic AI, multi-modal video policy reasoning, and automated compliance auditing.
            </p>
            <div className="pt-2 text-xs text-amber-400 flex items-center gap-2 font-medium">
              ...
              Agentic Engine Active & Systems Operational
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li><a href="#" className="hover:text-amber-400 transition-colors">Agentic Reasoning</a></li>
              <li><a href="#" className="hover:text-amber-400 transition-colors">Multi-Modal Vision & OCR</a></li>
              <li><a href="#" className="hover:text-amber-400 transition-colors">Audio Transcription</a></li>
              <li><a href="#" className="hover:text-amber-400 transition-colors">Rule Enforcement</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li><a href="#" className="hover:text-amber-400 transition-colors">Azure Security Benchmarks</a></li>
              <li><a href="#" className="hover:text-amber-400 transition-colors">Brand Integrity Rules</a></li>
              <li><a href="#" className="hover:text-amber-400 transition-colors">Evidence Logging</a></li>
              <li><a href="#" className="hover:text-amber-400 transition-colors">Audit Trail Reports</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li><a href="#" className="hover:text-amber-400 transition-colors">Architecture Blueprint</a></li>
            </ul>
          </div>
