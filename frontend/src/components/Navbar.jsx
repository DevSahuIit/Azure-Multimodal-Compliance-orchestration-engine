    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-800 bg-[#0F172A]/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <nav className="hidden items-center gap-8 text-sm font-medium text-slate-300 md:flex">
          <a href="#orchestration" className="transition-colors hover:text-amber-400">Orchestration</a>
          ...
          <a href="#evidence" className="transition-colors hover:text-amber-400">Evidence Logs</a>
